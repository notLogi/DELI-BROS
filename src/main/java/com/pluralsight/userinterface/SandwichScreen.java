...
public class SandwichScreen {
    ...
    public void addTopping(Scanner scanner, Sandwich sandwich){
        while(true) {
            ...
            switch (choice) {
                case 1 -> processMeatChoice(scanner, sandwich);
                case 2 -> processCheeseChoice(scanner, sandwich);
                case 3 -> processVegetableChoice(scanner, sandwich);
                case 4 -> processSauceChoice(scanner, sandwich);
                case 5 -> processSideChoice(scanner, sandwich);
